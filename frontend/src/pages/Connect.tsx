            ...
            <div className="w-full max-w-6xl flex flex-col gap-12">
                ...
                <section className="flex flex-col gap-4 items-center text-center py-6">
                    ...
                    <p className="text-[#8a7e60] text-lg max-w-2xl font-light">
                        Connect your Shopify store and upload supplementary data to power your AI research agent. The more data you provide, the smarter the insights.
                    </p>
                </section>
                ...
                <section className="flex flex-col gap-6">
                    <div className="flex items-center justify-between border-b border-[#e5e2db] pb-4">
                        <h2 className="text-2xl font-serif font-bold text-[#181611]">Store Integration</h2>
                        <span className="text-sm text-[#8a7e60]">Step 1 of 3</span>
                    </div>
                    <ShopifyConnectCard />
                </section>
                ...
                <div className="relative flex items-center">
                    ...
                    <span className="px-4 text-sm text-[#8a7e60] bg-[#FAFAF7]">or upload manually</span>
                    <div className="flex-1 border-t border-[#e5e2db]" />
                </div>
                ...
                <section className="flex flex-col gap-6">
                    <div className="flex items-center justify-between border-b border-[#e5e2db] pb-4">
                        <h2 className="text-2xl font-serif font-bold text-[#181611]">Manual Data Sources</h2>
                        <span className="text-sm text-[#8a7e60]">Step 2 of 3</span>
                    </div>
